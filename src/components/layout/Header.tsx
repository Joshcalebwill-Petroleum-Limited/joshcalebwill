...
export function Header() {
  ...
  // When at top of page (over hero) → light text; after scroll → dark text
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative h-11 w-11 overflow-hidden rounded-lg transition-transform duration-300 group-hover:scale-105">
              <Image
                src="/logo.png"
            ...
            <div className="hidden sm:block">
              ...
              <span
                className={cn(
                  ...
                  isLight ? "text-white/80" : "text-foreground-muted",
                )}
              >
                Energy & Beyond
              </span>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="lg:hidden border-t border-border bg-white max-h-[calc(100vh-5rem)] overflow-y-auto overscroll-contain"
          >
